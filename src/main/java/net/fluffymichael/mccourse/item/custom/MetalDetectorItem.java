package net.fluffymichael.mccourse.item.custom;
...
public class MetalDetectorItem extends Item {
    ...
    @Override
    public InteractionResult useOn(UseOnContext pContext) { //when you right-click on a block
    ...
    { //I18n makes sure the description of the block (the name) gets translated properly in the current language
